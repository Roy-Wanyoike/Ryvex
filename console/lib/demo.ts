...
/**
 * Demo snapshot mirroring the `ryvexd --seed` dataset. Used when the
 * console runs without a reachable control plane (NEXT_PUBLIC_RYVEX_API
 * unset) so recruiters and reviewers always see a living UI.
 */
...
export const DEMO_EVENTS: RyvexEvent[] = [
